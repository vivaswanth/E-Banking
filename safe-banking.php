...
<html>
	...
	<body>
	 ...
	 <div class="upar" style=" height:60px; ;background: rgba(3,3,3,0.5);">
            ...
            <li><a href="safe-banking.php" class="current">Safe-banking</a></li>
      ...
      <div class="container">
        ...
        <div class="features">
         ...
         <link rel="stylesheet" type="text/css" href="features.css">
            <h3 style="color:#40BC18;"><u>Please ensure the following before logging in</u></h3> 
            <ul>
            ...
            <h3 style="color:#40BC18;"><u>Beware of Phishing Attacks</u></h3>
            <ul>
